...
const pathsToMerge = ['auth.json', 'users.json', 'token.json', 'carts.json'];
...
fs.writeFileSync(path.join(__dirname, 'swagger.json'), JSON.stringify(baseContent, null, 2), 'utf-8');
